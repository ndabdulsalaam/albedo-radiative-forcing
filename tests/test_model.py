...
class TestScenario:
    ...
    def test_scenario_forcing_calculation(self) -> None:
        ...
        scenario = Scenario(
            initial_albedo=0.30,
            final_albedo=0.28,  # Darkening by 0.02
            area_fraction=0.5
        )
    ...
    def test_scenario_brightening(self) -> None:
        ...
        scenario = Scenario(
            initial_albedo=0.20,
            final_albedo=0.25,  # Brightening by 0.05
            area_fraction=1.0
        )
        result = scenario.forcing()
...
class TestAlbedoPipeline:
    ...
    def test_pipeline_clipping_behavior(self) -> None:
        ...
        scenario, _ = albedo_pipeline(
            ...
            albedo_delta=-1.0  # Large darkening
        )
...
class TestEndToEndWorkflows:
    ...
    def test_deforestation_scenario(self) -> None:
        ...
        scenario, forcing_result = albedo_pipeline(
            surface_type="vegetation",
            albedo_delta=delta,
            area_fraction=0.1  # 10% of Earth surface
        )
